...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="blurb">
        ...
        <div class="video">
            <h3><strong>1. Obstructions</strong></h3>
            <p>In this video Derek Evans shows the learner driver how to identify and navigate through obstructions</p>
            <iframe width="480" height="270" src="http://www.youtube.com/embed/SS_2vmPCrpY?autoplay=0" frameborder="0" allowfullscreen></iframe>


            <h3><strong>2. Reversing Around Corners</strong></h3>
            <p>In this video Derek Evans shows the learner driver the steps involved and how to correctly reverse around a corner </p>
            <iframe width="480" height="270" src="http://www.youtube.com/embed/E-RRTZ-2ulQ?autoplay=0" frameborder="0" allowfullscreen></iframe>
        </div>
